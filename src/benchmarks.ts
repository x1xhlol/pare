...
export const BENCHMARKS: { name: string; detail: string; before: number; after: number; seconds: number; ssim: number }[] = [
  { name: 'Camera footage', detail: '1080p30, 10 s, H.264 at 62 Mbps', before: 77_919_498, after: 16_349_821, seconds: 19, ssim: 0.994 },
  { name: 'Phone clips', detail: '1080p50, 20 s, H.264 at 26 Mbps', before: 65_458_226, after: 30_071_228, seconds: 42, ssim: 0.9505 },
  { name: 'Animation', detail: 'Big Buck Bunny, 1080p30, 10 s', before: 30_704_510, after: 14_048_752, seconds: 29, ssim: 0.9814 },
  { name: 'Screen recording', detail: '1080p30, 8 s, scrolling text', before: 10_814_518, after: 4_098_460, seconds: 8, ssim: 0.9995 },
]
